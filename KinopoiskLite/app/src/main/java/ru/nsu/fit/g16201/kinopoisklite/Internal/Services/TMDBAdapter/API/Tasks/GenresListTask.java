...
public class GenresListTask extends AsyncTask<URL, Void, GenreList> {
    private JsonAdapter<GenreList> adapter = moshi.adapter(GenreList.class);
    @Override
    protected GenreList doInBackground(URL... urls) {
        URL url = urls[0];

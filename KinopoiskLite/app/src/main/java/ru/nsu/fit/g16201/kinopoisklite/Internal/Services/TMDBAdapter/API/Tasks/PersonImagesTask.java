...
public class PersonImagesTask extends AsyncTask<URL, Void, PersonImagesInfo> {
    private JsonAdapter<PersonImagesInfo> adapter = moshi.adapter(PersonImagesInfo.class);

    @Override
    protected PersonImagesInfo doInBackground(URL... urls) {
        URL url = urls[0];
        ...
        try {
            ...
            Log.e("PersonImagesTask", "Cannot create connection: " + e.getMessage());
            return null;
        }
        ...
        try {
            ...
            Log.e("PersonImagesTask", "Cannot open connection: " + e.getMessage());
            return null;
        }
